...
def remove_artifacts_custom(data, acquisition_frequency, delete_start_stim, delete_end_stim):
    processed_data = np.copy(data)  # Make a copy of the data to avoid modifying the original
...
class GUI(object):
    ...
    def apply_stim_removal(self):   
        ...
        if self.experiment_type_var.get() in self.EPSP_list:
                ...
                #(data, acquisition_frequency, delete_start_stim, delete_end_stim)
                temp_data = remove_artifacts_custom(self.current_trace, self.data_df['acquisition_frequency'][index], float(self.delete_start_stim_entry.get()), float(self.delete_end_stim_entry.get()))
    ...
    def open_saved_data(self):
        try:
            ...
            #do not edit the analysis steps and the current trace key
